...
#define HEXNORTHEAST 5
	 */
	final static Color COLORWOOL = new Color (0, 250, 154);
	final static Color COLORWHEAT = Color.orange;
	final static Color COLORORE = new Color(104, 143,173);
	final static Color COLORDESERT = new Color(194, 178, 128);
	final static Color COLORBRICK = new Color(132, 31,39);
	final static Color COLORLUMBER = new Color(77, 158, 58);
...
*********************************************************************/
	public static void drawHex(int i, int j, Graphics2D g2, Hex resource) {// add new input that links the hexes to the grid
		...
		else if(resource.getResourceType() == "wheat") {
